 // Variaveis do jogo
 var canvas, ctx, ALTURA, LARGURA, frames = 0, maxPulos = 3, velocidade = 8, estadoAtual, record,
 estados = {
     jogar: 0,
     jogando: 1,
     perdeu: 2
 ...
 obstaculos = {
     ...
     insere: function() {
         this._obs.push({
             x: 600, 
            // Definir largura aleatória // largura: 30 + Math.floor(20 * Math.random()),
            largura: 50, 
 ...
 function desenha() {
     ...
     if (estadoAtual == estados.jogar) {
         ...
         ctx.fillText(bloco.score, -52, 19);
